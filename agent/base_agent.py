...
class Agent():
    ...
    def initialize_policy(self, state, action):
        raise NotImplemetedError("Different policies Linear or QTable based policy will be initialized by the sub classes")


    def train_policy(self, world, logdir = ""):
        raise NotImplemetedError("Training methodology will change based on the policy in the sub classes")
...
class DiscreteAgent(Agent):
    '''
    ' This is a discrete state space agent with Q policy
    ' At this state I dont believe this works as the LLM Standardized never incorporated the Q Table.
    ' TODO: fix this
    '''
    def __init__(
        self,
