...
class CliffWalkingAgent:
    ...
    def rollout_episode(self, world: CliffWalkingWorld, logging_file):
        state = world.reset()
    ...
    def train_policy(self, world: CliffWalkingWorld, logdir):
    ...
    def evaluate_policy(self, world: CliffWalkingWorld, logdir):
        results = []
