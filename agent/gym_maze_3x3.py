...
class Maze3x3Agent:
    ...
    def rollout_episode(self, world: Maze3x3World, logging_file):
        state = world.reset()
    ...
    def train_policy(self, world: Maze3x3World, logdir):
    ...
    def evaluate_policy(self, world: Maze3x3World, logdir):
        results = []
