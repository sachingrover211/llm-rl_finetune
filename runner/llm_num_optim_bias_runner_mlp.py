from world.mujoco_general import MujocoGeneralWorld
from agent.llm_num_optim_bias_rndm_proj_mlp import LLMNumOptimRndmPrjAgentMLP
...
def run_training_loop(
    ...
    assert task == "mujoco_llm_num_optim_bias_mlp_rndm_proj"
    ...
    world = MujocoGeneralWorld(
        gym_env_name,
        render_mode,
        max_traj_length,
    )

    agent = LLMNumOptimRndmPrjAgentMLP(
        logdir,
        dim_actions,
        dim_states,
        max_traj_count,
