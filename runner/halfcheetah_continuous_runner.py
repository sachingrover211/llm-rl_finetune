...
from agent.halfcheetah_linear import HalfcheetahLinearAgent
...
def run_training_loop(
    ...
    assert task == "halfcheetah_continuous"
    ...
    world = HalfcheetahContinuousWorld(
        gym_env_name, 
        render_mode, 
        max_traj_length,
    )
    agent = HalfcheetahLinearAgent(
        logdir,
        dim_actions,
        dim_states,
        max_traj_count,
