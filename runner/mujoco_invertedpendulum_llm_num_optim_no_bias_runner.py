...
from agent.mujoco_invertedpendulum_llm_num_optim_no_bias import MujocoInvertedPendulumLLMNumOptimAgent
...
def run_training_loop(
    ...
    assert task == "mujoco_invertedpendulum_llm_num_optim_no_bias"
    ...
    world = MujocoInvertedPendulumWorld(
        gym_env_name, 
        render_mode, 
        max_traj_length,
    )
    agent = MujocoInvertedPendulumLLMNumOptimAgent(
        logdir,
        dim_actions,
        dim_states,
        max_traj_count,
