...
from agent.mountain_car_continuous_grid_search_no_bias import MountaincarContinuousActionGridSearchAgent
...
def run_training_loop(
    ...
    assert task == "mountaincar_continuous_action_grid_search_no_bias"
    ...
    agent = MountaincarContinuousActionGridSearchAgent(
        logdir,
        dim_actions,
        dim_states,
        max_traj_count,
