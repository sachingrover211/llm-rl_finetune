...
from agent.mujoco_invertedpendulum_grid_search_no_bias import MujocoInvertedpendulumGridSearchAgent
...
def run_training_loop(
    ...
    assert task == "mujoco_invertedpendulum_grid_search_no_bias"
    ...
    agent = MujocoInvertedpendulumGridSearchAgent(
        logdir,
        dim_actions,
        dim_states,
        max_traj_count,
